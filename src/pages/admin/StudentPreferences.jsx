  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
        ...
        <div style={{ position: 'relative', width: 260 }}>
          <HiMagnifyingGlass style={{
            ...
            width: 15, height: 15,
            color: searchFocused ? '#c9a84c' : '#3a4a60',
            pointerEvents: 'none',
      ...
      <div style={{
        ...
        <div style={{ background: '#0d1425', padding: '14px 18px', textAlign: 'center' }}>
          <div style={{
            fontFamily: "'Playfair Display', serif",
            fontSize: 24, fontWeight: 700, color: '#c9a84c', lineHeight: 1,
          }}>
            {students.length}
          </div>
          <div style={{ fontSize: 10, color: '#3a4a60', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 600, marginTop: 4 }}>
            Total Students
          </div>
        </div>
        <div style={{ background: '#0d1425', padding: '14px 18px', textAlign: 'center' }}>
        ...
        <div style={{ background: '#0d1425', padding: '14px 18px', textAlign: 'center' }}>
          <div style={{
            ...
            color: withoutPrefs.length > 0 ? '#ba7517' : '#3a4a60',
            lineHeight: 1,
          }}>
            {withoutPrefs.length}
          </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <HiQueueList style={{ width: 15, height: 15, color: '#c9a84c' }} />
          <span style={{
            fontFamily: "'Playfair Display', Georgia, serif",
        ...
        {filtered.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '60px 24px', color: '#2a3548' }}>
            <HiUserGroup style={{ width: 36, height: 36, margin: '0 auto 12px', color: '#1e2a3a' }} />
            <div style={{ fontSize: 14, fontWeight: 500, color: '#3a4a60' }}>No students found</div>
          </div>
        ) : (
                    ...
                    >
                      ...
                      <td style={tdStyle}>
                        {hasPrefs ? (
                              ...
                              <span
                                ...
                                style={{
                                  ...
                                  border: i === 0
                                    ...
                                    : '1px solid rgba(255,255,255,0.07)',
                                  color: i === 0 ? '#c9a84c' : '#5e6d85',
                                }}
                              >
                                <span style={{
                                  fontSize: 9, fontWeight: 700,
                                  color: i === 0 ? '#c9a84c' : '#3a4a60',
                                }}>
                                  {i + 1}.
                                </span>
                                {getCourseName(pref)}
                          ...
                          <span style={{ color: '#2a3548', fontSize: 13 }}>—</span>
                        )}
                      </td>
